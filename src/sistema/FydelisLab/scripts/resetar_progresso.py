...
CORRIGIDO: Duplicação de botões removida e salvamento de progresso integrado
"""
...
def show_certificate(parent, player_name, level, custom_bg_path=None,
    ...
    # Botões (Renderizados estritamente UMA VEZ)
...
class FydelisLabApp:
    def __init__(self, root, custom_cert_bg=None):
        ...
        # Salva progresso quando o usuário fecha a janela
